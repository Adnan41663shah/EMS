...
const SalesInquiries: React.FC = () => {
  ...
  const { data, isLoading } = useQuery(
    ...
    () => apiService.inquiries.getAll({ ...filters, department: 'sales' } as any),
    {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const response = await apiService.inquiries.getAll({ ...exportFilters, department: 'sales' } as any);
      ...
      <div className="flex items-center justify-between">
        <div className="flex-1">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Manage and track all sales inquiries
          </p>
        </div>
